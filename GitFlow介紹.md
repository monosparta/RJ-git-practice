...
為什麼要合併回 Develop 分支？如果不這麼做，等到時候 Develop 分支完成並且合併回 Release 分支，測試時又再次發現那個BUG。
...
資料來源:https://gitbook.tw/chapters/gitflow/why-need-git-flow?fbclid=IwAR3GNkVjRhUe-dPFTIKXayRXSts7hwl1SdRr7RE_MHt6VphCyajRR211c1c